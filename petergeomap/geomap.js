...
const getRestPlaces = (coords) => {
    ...
    $.ajax({
        ...
        for (let i = 0; i < source.length; i++) {
            ...
            //pushes place id into contactsIDs
            contactIDs.push(place);
            contactIDs.sort(dynamicSort("rating"));

        }
        //renders place markers to the map
        renderMarks(map, contactIDs);
    });
}
        ...
        service.getDetails({
            ...
            if (status === google.maps.places.PlacesServiceStatus.OK) {
                ...
                function checkPhone() {
                    ...
                    if (typeof phone_number !== typeof undefined && phone_number !== false) {
                        //if phone number is present, add phone to the content
                        return `<br> ${phone_number} <br>`;
                ...
                function checkHours() {
                    ...
                    let hour_operation = place.opening_hours.weekday_text;
                    ...
                    if(isOpen === true)
                    {
                        ...
                        displayHours = hours_operation[dayOfTheWeekIndex];
